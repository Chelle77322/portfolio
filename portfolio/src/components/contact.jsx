...
export default class Contact extends React.Component {
	render() {
		...
		<form className={this.props.shake}
	...
	<div className="form-group hidden">
		...
		<div className="row">
		<div className="col-12 col-sm-12 col-md-6 mx-auto">
		<textarea name="message" className="form-control form-control-lg"
		...
		<div className="col-12 col-sm-12 col-md-6 mx-auto">
		<button type="submit"className="btn btn-primary mb-2 hidden"> Submit</button>
		</div>
		</div>
				</form>
			</div>
